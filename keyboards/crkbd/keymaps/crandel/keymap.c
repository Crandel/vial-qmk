...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,----------------------------------------------------------------------.    ,--------------------------------------------------------------------------.
     XXXXXXX, LGUI_T(KC_Q), LALT_T(KC_W), LCTL_T(KC_F), LSFT_T(KC_P),  KC_B,       KC_E, LSFT_T(KC_I), LCTL_T(KC_U), RALT_T(KC_Y), LGUI_T(KC_SCLN), XXXXXXX,
  //|-------+-------------+-------------+-------------+-------------+------|    |------+-------------+-------------+-------------+----------------+--------|
  ...
  //,--------------------------------------------------------------------------.    ,---------------------------------------------------------------------------------------.
      XXXXXXX, LGUI_T(KC_F5), LALT_T(KC_7), LCTL_T(KC_4), LSFT_T(KC_2), KC_MINS,          KC_HOME, LSFT_T(KC_END), LCTL_T(KC_PGDN), RALT_T(KC_PGUP), LGUI_T(KC_DOT), XXXXXXX,
  //|--------+--------------+-------------+-------------+-------------+--------|    |------------+---------------+----------------+----------------+---------------+--------|
      XXXXXXX,         KC_F4,         KC_8,         KC_5,         KC_1,    KC_3,           KC_DOT,        KC_LEFT,         KC_DOWN,           KC_UP,       KC_RIGHT, XXXXXXX,
  //|--------+--------------+-------------+-------------+-------------+--------|    |------------+---------------+----------------+----------------+---------------+--------|
      XXXXXXX,         KC_F3,         KC_9,         KC_6,         KC_0,   KC_F2,          KC_BTN4,        KC_BTN1,         KC_BTN2,         KC_BTN3,        KC_BSLS, XXXXXXX,
  //---------+--------------+-------------+-------------+-------------+--------|    |------------+---------------+----------------+----------------+---------------+--------|
                                                 QK_LEAD,       KC_SPC,   TD(0),           KC_ENT,         KC_TAB,         KC_BSPC
                                                 //`---------------------------'    `---------------------------------------------'
  ),
